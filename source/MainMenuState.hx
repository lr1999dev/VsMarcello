...
class MainMenuState extends MusicBeatState
{
	...
	public static var sickGaming:Int = 0;

	public static var kadeEngineVer:String = "1.2.1";
	public static var gameVer:String = "0.2.7.1";
	public static var editionName:String = "Punjabi no virus";
	...
	override function create()
	{
		...
		var versionShit:FlxText = new FlxText(5, FlxG.height - 18, 0, editionName + " Engine 1.2", 12);
	...
	function changeItemDirectly(huh:Int = 0)
	{
		curSelected = huh;
