...
class StoryMenuState extends MusicBeatState
{
	...
	override function create()
	{
		...
		weekBg = new FlxSprite(0, 56).loadGraphic(Paths.image("storymenu/none"));
		...
		for (char in 0...3)
		{
			...
			switch (weekCharacterThing.character)
			{
				...
				case 'parents-christmas':
					...
					weekCharacterThing.updateHitbox();
				case 'marcello':
					weekCharacterThing.setGraphicSize(Std.int(weekCharacterThing.width * 0.75));
					weekCharacterThing.updateHitbox();
			}
	...
	function changeDifficultyDirectly(change:Int = 0):Void
	{
		curDifficulty = change;
	...
	function updateText()
	{
		...
		switch (grpWeekCharacters.members[0].animation.curAnim.name)
		{
			...
			case 'marcello':
				...
				grpWeekCharacters.members[0].setGraphicSize(Std.int(grpWeekCharacters.members[0].width * 0.75));
	...
	function updateWeekBg()
	{
		...
		weekBg.destroy();
		weekBg = new FlxSprite(0, 56).loadGraphic(imgPath);
		weekBg.antialiasing = true;
		weekBg.active = false;
		add(weekBg);
	}
